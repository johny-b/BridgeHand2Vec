...
cem.train(agent_vec, boards, boards_val, n_sessions=100, n_steps=1600, percentile=70, emb_net=emb_net,
...
cem.train(agent, boards, boards_val, n_sessions=100, n_steps=1600, percentile=70)
